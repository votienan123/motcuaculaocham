...
public class ThongKeNguoiDangTaiNgoaiService extends ThongKeService{
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.BI_XU_LY_HINH_SU_DANG_DUOC_TAI_NGOAI))
