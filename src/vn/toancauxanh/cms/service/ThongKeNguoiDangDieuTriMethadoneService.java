...
public class ThongKeNguoiDangDieuTriMethadoneService extends ThongKeService{
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.DIEU_TRI_METHADONE))
