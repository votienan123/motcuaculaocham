...
public class ThongKeNguoiNghienDangGiaoDucTaiXaPhuongService extends ThongKeService{
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.GIAO_DUC_TAI_XA_PHUONG))
