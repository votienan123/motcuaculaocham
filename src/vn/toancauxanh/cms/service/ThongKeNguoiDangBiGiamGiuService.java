...
public class ThongKeNguoiDangBiGiamGiuService extends ThongKeService{
	...
	public void thongKeKetQua() {
		...
		for (HinhThucXuLy hinhThuc : core().getHinhThucXuLys().getListHinhThucXuLyGiamGiu()) {
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.BI_XU_LY_HINH_SU_O_TRAI_TAM_GIAM)
						.or(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.BI_XU_LY_HINH_SU_O_NHA_TAM_GIU)))
