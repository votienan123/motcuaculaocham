...
public class ThongKeNguoiDangCaiNghienTaiTapTrungService extends ThongKeService{
	...
	public void thongKeKetQua() {
		...
		for (HinhThucXuLy hinhThuc : core().getHinhThucXuLys().getListHinhThucXuLyCaiNghienTapTrung()) {
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.TAP_TRUNG_CAI_NGHIEN_BAT_BUOC)
						.or(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.TAP_TRUNG_CAI_NGHIEN_TU_NGUYEN)))
