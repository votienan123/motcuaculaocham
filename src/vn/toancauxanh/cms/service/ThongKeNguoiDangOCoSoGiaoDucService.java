...
public class ThongKeNguoiDangOCoSoGiaoDucService extends ThongKeService{
	...
	public void thongKeKetQua() {
		...
		for (HinhThucXuLy hinhThuc : core().getHinhThucXuLys().getListHinhThucXuLyGiaoDuc()) {
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.DUA_VAO_CO_SO_GIAO_DUC)
						.or(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.DUA_VAO_TRUONG_GIAO_DUONG)))
