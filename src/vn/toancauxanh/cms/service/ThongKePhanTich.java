...
public class ThongKePhanTich extends ThongKeService{
	...
	public void thongKeKetQua() {
		...
		System.out.println("old16: " + old16);
		System.out.println("old18: " + old18);
		System.out.println("old30: " + old30);
			...
			for (HinhThucXuLy hinhThuc : core().getHinhThucXuLys().getListHinhThucXuLyNguoiNghien()) {
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.loaiDoiTuong.eq(LoaiDoiTuong.NGUOI_NGHIEN_MA_TUY)
						.or(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.loaiDoiTuong.eq(LoaiDoiTuong.TUY_TRUONG_HOP)))
				.where(QDoiTuong.doiTuong.nguoiNghien.eq(true))
		...
		if (getSelectedQuanHuyenTK() != null) {
			q.where(QDoiTuong.doiTuong.diaChiThuongTruHuyen.eq(getSelectedQuanHuyenTK()));
		}
		if (getSelectedPhuongXaTK() != null) {
			q.where(QDoiTuong.doiTuong.diaChiThuongTruXa.eq(getSelectedPhuongXaTK()));
		}
