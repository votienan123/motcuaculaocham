...
public class ThongKeNguoiDangCaiNghienTaiGiaDinhCongDongService extends ThongKeService{
	...
	public void thongKeKetQua() {
		...
		for (HinhThucXuLy hinhThuc : core().getHinhThucXuLys().getListHinhThucXuLyCaiNghienTaiCongDong()) {
		...
		soLieu.setSoLieuTatCaNguoi(getQueryThongTin()
				...
				.fetchCount());
		soLieu.setSoLieuNghienMoi(getQueryThongTin()
				.where(qT.doiTuongNghien.eq(DoiTuongNghien.NGHIEN_MOI))
				.fetchCount());
		soLieu.setSoLieuTaiNghien(getQueryThongTin()
				.where(qT.doiTuongNghien.eq(DoiTuongNghien.TAI_NGHIEN))
				.fetchCount());
	...
	public JPAQuery<DoiTuong> getQueryThongTin() {
		JPAQuery<DoiTuong> q = find(DoiTuong.class)
				.where(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.CAI_NGHIEN_TU_NGUYEN_TAI_GIA_DINH)
						.or(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.CAI_NGHIEN_TU_NGUYEN_TAI_CONG_DONG))
						.or(QDoiTuong.doiTuong.thongTinViPhamHienHanh.hinhThucXuLy.hinhThucXuLyEnum.eq(HinhThucXuLyEnum.CAI_NGHIEN_BAT_BUOC_TAI_CONG_DONG)))
